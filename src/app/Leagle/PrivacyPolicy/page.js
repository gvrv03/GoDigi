...
const page = () => {
  return (
    <div className=" p-5 bg-white h-full text-justify ">
          <SingleHeader  title2Nd="Privacy Policy" />
      ...
      <div >
        ...
        <h2 className="text-xl font-semibold mt-2">Types of Data Collected</h2>
        <h3 className="text-sm font-semibold mt-2">Personal Data</h3>
        <p>
        ...
        <h3 className="text-sm font-semibold mt-2">Usage Data</h3>
        ...
        <h3 className="text-sm font-semibold mt-2">Business Transactions</h3>
        <p>
        ...
        <h3 className="text-sm font-semibold mt-2">Law enforcement</h3>
        <p>
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h3 className="text-sm font-semibold mt-2">Other legal requirements</h3>
        <p>
        ...
        <h1 className="font-bold text-2xl mt-5">Children&#39;s Privacy</h1>
        <p>
          ...
          <li>
            <p>
              ...
              <Link
                ...
                rel="external nofollow noopener"
                target="_blank"
                className="pColor font-semibold"
              >
