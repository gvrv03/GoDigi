...
const Disclaimer = () => {
  return (
    <div className=" bg-white p-5 h-full text-justify ">
      <SingleHeader  title2Nd="Disclaimer" />
      ...
      <div>
        ...
        <h1 className="font-bold text-2xl mt-5">Disclaimer</h1>
        <p>
        ...
        <h1 className="font-bold text-2xl mt-5">External Links Disclaimer</h1>
        <p>
        ...
        <h1 className="font-bold text-2xl mt-5">Fair Use Disclaimer</h1>
        <p>
        ...
        <h1 className="font-bold text-2xl mt-5">Views Expressed Disclaimer</h1>
        <p>
