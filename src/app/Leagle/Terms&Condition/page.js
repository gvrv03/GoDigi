  ...
  return (
    <div className="p-5 bg-white h-full  text-justify ">
      ...
      <div>
        ...
        <h2 className="text-xl font-semibold mt-2">Interpretation</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold mt-2">Definitions</h2>
        ...
        <h1 className="font-bold text-2xl mt-5">Acknowledgment</h1>
        <p>
        ...
        <h1 className="font-bold text-2xl mt-5">Links to Other Websites</h1>
        <p>
        ...
        <h1 className="font-bold text-2xl mt-5">Termination</h1>
        <p>
        ...
        <h1 className="font-bold text-2xl mt-5">Limitation of Liability</h1>
        <p>
        ...
        <h1 className="font-bold text-2xl mt-5">Governing Law</h1>
        <p>
        ...
        <h1 className="font-bold text-2xl mt-5">Disputes Resolution</h1>
        <p>
        ...
        <h2 className="text-xl font-semibold mt-2">Waiver</h2>
        <p>
        ...
        <h1 className="font-bold text-2xl mt-5">Translation Interpretation</h1>
        <p>
        ...
        <ul className="list-disc ml-16">
          <li>
            <p>By email: gauravnarnaware3112003@gmail.com</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <a
                href="https://www.gauravnarnaware.com/ContactUs"
                rel="external nofollow noopener"
                target="_blank"
              >
                {" "}
                https://www.gauravnarnaware.com/ContactUs
              </a>
            </p>
          </li>
        </ul>
